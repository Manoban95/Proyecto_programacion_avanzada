            ...
            <tr>
              ...
              <td>
               ...
               <td>
                ...
                <button   onclick="editUser({{ $user->id }}, '{{ $user->name }}', '{{ $user->email }}', '{{ $user->password }}')" class="btn btn-warning" data-toggle="modal" data-target="#editUserModal">
                  Edit 
                </button>
...
<script type="text/javascript">
      ...
      function editUser(id,name,mail,password){
